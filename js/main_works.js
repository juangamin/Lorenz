...
// Create spheres:
const sphereMeshes = [];
const sphereGeometry = new THREE.SphereGeometry(0.05, 32, 32); // Define geometry
...
const lightValues = [
    {colour: 0x14D14A, intensity: 128, dist: 82, x: 1, y: 0, z: 8},
    {colour: 0xBE61CF, intensity: 226, dist: 82, x: -2, y: 1, z: -10},
    {colour: 0x00FFFF, intensity: 223, dist: 80, x: 0, y: 10, z: 1},
    {colour: 0x00FF00, intensity: 226, dist: 82, x: 0, y: -10, z: -1},
    {colour: 0x16A7F5, intensity: 226, dist: 82, x: 10, y: 3, z: 0},
    {colour: 0x90F615, intensity: 226, dist: 82, x: -10, y: -1, z: 0}
];
for (let i=0; i<6; i++) {
